...
//qEngine.makeQuestions = function(article, next) {
////    var count = 0;
////    var length = sentences.length;
////    var bakedSentences = [];
////    
...
////    }
//    
//    qEngine.decompose(article, function(rSentence){
//        qEngine.generateQuestionHtml(rSentence);
//    });
//};

qEngine.generateQuestionHtml = function(sentences) {
    console.log(JSON.stringify(sentences));
};
